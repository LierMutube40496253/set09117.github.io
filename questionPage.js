...
function handleClickWrong() {
	...
	document.getElementById("next-button").style.backgroundColor = "#58a4b0";
...
answer1.addEventListener('click', handleClickRigth);
...
answer2.addEventListener('click', handleClickWrong);
